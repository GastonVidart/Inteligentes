...
public class RedNeuronalPokerBinarioTest {
    ...
    public static void setUpClass() {
        ...
        redNeuronal = new RedNeuronal(new int[]{traductor.getCantEntradas(), 25, 20, 10});
    }
